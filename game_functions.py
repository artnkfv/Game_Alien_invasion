...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets,
    ...
    # Draw the score button if th game is inactive.
    sb.show_score()
...
def update_bullets(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """ Update position of bullets and ger rid of old ones """
    ...
    # Call funktion to check collision between alien and bullet
...
def get_number_aliens_x(ai_settings, alien_width):
    """ Determine number of aliens that fit the row"""
...
def create_fleet(ai_settings, screen, ship, aliens):
    ...
    # Create an alien and find the number of aliens in a roe.
...
def update_aliens(ai_settings, stats, screen, sb, ship, aliens, bullets):
    ...
    check if the fleet is at the edge,
      and then Update positions of the aliens in the fleet.
    """
